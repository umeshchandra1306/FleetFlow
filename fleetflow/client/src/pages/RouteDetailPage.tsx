  ...
  return (
    <div className="p-4 lg:p-6">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-0.5">Detailed route information and map</p>
      </div>
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-12 text-center">
        ...
        <p className="text-sm text-gray-500 mb-4">Route detail page is under development.</p>
        <button
