    ...
    <div className="p-4 lg:p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Vehicle fleet overview and tracking</p>
        </div>
      </div>
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-12 text-center">
        ...
        <p className="text-sm text-gray-500 mb-4">Fleet management page is under development.</p>
        <button
